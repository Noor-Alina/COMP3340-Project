        ...
        <div className="float-child">
          ...
          <section>
            <form className="contact-form" onSubmit={this.handleSubmit.bind(this)} method="POST">
              ...
              <label className="contact-label" for="message">Message: <br /><textarea className="contact-text" class="c-control" rows="5" cols="26" placeholder="Your Message" required></textarea> </label><br />
